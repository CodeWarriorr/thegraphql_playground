...
import type { UsdbTypes } from './sources/usdb/types';
import * as importedModule$0 from "./sources/usdb/introspectionSchema";
...
export type AccountResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Account'] = ResolversParentTypes['Account']> = ResolversObject<{
  ...
  lastTransferBlockNo?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>;
  lastTransferTxIndex?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>;
  lastTransferTimestamp?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>;
...
export type MeshContext = UsdbTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/usdb/introspectionSchema":
...
const usdbTransforms = [];
const additionalTypeDefs = [] as any[];
const usdbHandler = new GraphqlHandler({
              name: "usdb",
              config: {"endpoint":"https://api.studio.thegraph.com/query/76603/usdb/version/latest"},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("usdb"),
              logger: logger.child("usdb"),
              importFn,
            });
sources[0] = {
          name: 'usdb',
          handler: usdbHandler,
          transforms: usdbTransforms
        }
